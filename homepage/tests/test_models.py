...
class TestModels(TestCase):
    def setUp(self):
        ...
        self.rti_file = RTI_File.objects.create(
            ...
            Has_TZI=False,
            Has_Image=True,
            Info_File=SimpleUploadedFile(name='info.json', content=b'{}', content_type='application/json'),
            RTI_Zip=SimpleUploadedFile(name='rti.zip', content=b'', content_type='application/zip'),
            Item=self.item
        )
